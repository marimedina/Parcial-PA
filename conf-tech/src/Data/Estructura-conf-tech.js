export const   speaker = [ {
 ...
 {
     'biography' : 'Soy Win. Hago fotografía los domingos. Head of production at next',
     'category' : 12,
 ...
 {
     'biography' : 'Líder del equipo de Growth y Google Doc Expert en Marketing, especialista en análisis de datos, presupuesto y proyecciones de Startups, lo que lo ha llevado a ser un gran conferencista a nivel mundial. Recuerden si estamos haciendo algo y no estamos aprendiendo de ello, no sirve de nada.',
     'category' : 9,
 ...
 {
     'biography' : 'Course Director del equipo de Education en Relo. Blogguera y periodista del Universal en México, especialista en técnicas orales y escritas del periodismo con una amplia visión en el mundo digital.',
     'category' : 7,
...
export const conference  = [
 ...
 {
     "datetime" : 1564862400,
     "description" : "En esta charla Erika Oregel del equipo de GOO nos invita a explorar nueva forma de adquirir gustos y pasiones, nos invita a procrastinar de forma consciente.",
